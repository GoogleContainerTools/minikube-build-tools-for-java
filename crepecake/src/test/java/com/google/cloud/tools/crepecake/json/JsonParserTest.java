...
public class JsonParserTest {
  ...
  public void testFromJson() {
    ...
    jsonBuffer.append("digest: \"sha256:8c662931926fa990b41da3c9f42663a537ccd498130030f9149173a0493832ad\",");
    ...
    jsonBuffer.append("\"sha256:91e0cae00b86c289b33fee303a807ae72dd9f0315c16b74e6ab0cdbe9d996c10\"");
    jsonBuffer.append("\"sha256:4945ba5011739b0b98c4a41afe224e417f47c7c99b2ce76830999c9a0861b236\"");
    jsonBuffer.append("]");
    jsonBuffer.append("},");
    ...
    jsonBuffer.append("digests: [\"sha256:d38f571aa1c11e3d516e0ef7e513e7308ccbeb869770cb8c4319d63b10a0075e\"]");
    jsonBuffer.append("}");
    jsonBuffer.append("]");
    jsonBuffer.append("}");
    ...
    Assert.assertEquals(Digest.fromDigest("sha256:8c662931926fa990b41da3c9f42663a537ccd498130030f9149173a0493832ad"), testJson.digest);
    ...
    Assert.assertEquals(Digest.fromDigest("sha256:91e0cae00b86c289b33fee303a807ae72dd9f0315c16b74e6ab0cdbe9d996c10"), testJson.innerObject.digests.get(0));
    Assert.assertEquals(Digest.fromHash("4945ba5011739b0b98c4a41afe224e417f47c7c99b2ce76830999c9a0861b236"), testJson.innerObject.digests.get(0));
    ...
    Assert.assertEquals(Digest.fromDigest("sha256:d38f571aa1c11e3d516e0ef7e513e7308ccbeb869770cb8c4319d63b10a0075e"), testJson.list.get(1).digests.get(0));
  }
  ...
  public void testToJson() {
    ...
    testJson.digest = Digest.fromDigest("sha256:8c662931926fa990b41da3c9f42663a537ccd498130030f9149173a0493832ad");
    ...
    testJson.digest = Arrays.asList(
        Digest.fromDigest("sha256:91e0cae00b86c289b33fee303a807ae72dd9f0315c16b74e6ab0cdbe9d996c10"),
    ...
    innerObject2.digests = Collections.singletonList(Digest.fromDigest("sha256:d38f571aa1c11e3d516e0ef7e513e7308ccbeb869770cb8c4319d63b10a0075e"));
